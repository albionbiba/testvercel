...
function RLTableRow({ name, surname, referralName, city, street, phoneNumber, jobPosition, company, date }: any) {
  return (
    <div className="mt-10 ml-10 mr-10 pt-1 pb-1 flex gap-5 pr-7 pl-3.5 bg-white rounded-md max-md:flex-wrap max-md:pr-5 mb-5 mt-10">
      <div className="flex gap-2 items-center mt-1 text-base text-sky-950">
        ...
        <div className="self-stretch my-auto">
          <span className="font-light text-indigo-500 text-sm">Referral :</span>
          <br />
      ...
      <div className="flex flex-auto gap-5 justify-between my-auto max-md:flex-wrap max-md:max-w-full">
        <div className="flex flex-col my-auto text-base">
          <div className="font-light text-indigo-500">
            <span className="text-indigo-500 text-sm">{city}, {street}</span>{" "}
          </div>
          <div className="mt-4 text-sky-950 text-sm">{phoneNumber}</div>
        </div>
        <div className="my-auto text-base text-indigo-500">
          {jobPosition}
          <br />
          in <span className="font-light text-indigo-500 text-sm">{company}</span>
        </div>
        <button>
          <div className="flex justify-center items-center self-start w-12 h-12 bg-white rounded-full">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/8694e098c7a4500097df7fac0062abd5ac7116d3ed93ae18798118048406ab79?"
              className="w-8 aspect-square"
            />
          </div>
        </button>
        
        <div className="justify-center px-2 py-2 text-sm bg-gray-100 rounded-xl text-neutral-500">
