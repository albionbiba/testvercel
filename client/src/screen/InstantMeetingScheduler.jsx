...
const InstantMeetingScheduler = () => {
  ...
  const radioOptions = [
    { value: 'successful', label: 'Successful', check: 'successful' },
  ...
  return (
    <div className="container">
      <form onSubmit={handleSubmit}>
        ...
        <TimeslotField label="Timeslot" value={formData.timeslot} onChange={(e) => handleChange({ target: { name: 'timeslot', value: e.target.value } })} />
